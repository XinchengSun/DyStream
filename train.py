...
class InferenceCallback(Callback):
    ...
    def on_train_start(self, trainer, pl_module):
        ...
        if hasattr(experiment, "define_metric"):
...
def main():
    ...
    if cfg.resume_ckpt and resume_mode == "weights_only":
        ...
        rank_zero_info(f"Loaded model weights from {cfg.resume_ckpt}; trainer state will start fresh")
        fit_ckpt_path = None
